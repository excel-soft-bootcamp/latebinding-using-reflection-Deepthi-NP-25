...
namespace GameApp
{
    ...
    class Program
    {
      ...
      System.Reflection.Assembly.LoadFile(@"C:\Users\deepthi.np\Downloads\latebinding-using-reflection-Deepthi-NP-25-main\latebinding-using-reflection-Deepthi-NP-25-main\GameApp\bin\Debug\BasicLevelLib.dll");
                ...
                case Options.INTERMEDIATE:
                    ...
                    System.Reflection.Assembly.LoadFile(@"C:\Users\deepthi.np\Downloads\latebinding-using-reflection-Deepthi-NP-25-main\latebinding-using-reflection-Deepthi-NP-25-main\GameApp\bin\Debug\IntermediateLevelLib.dll");
                    ...
                    if (intermediateTypeClassRef != null)
                    {
                        if (intermediateTypeClassRef.IsClass)
                        {
                            ...
                            if (!_methodRef.IsStatic)
                            {
                                object result = _methodRef.Invoke(objRef, new object[] { "jack" });
                                Console.WriteLine(result.ToString());
                            }
                ...
                case Options.ADVANCED:
                    ...
                    System.Reflection.Assembly.LoadFile(@"C:\Users\deepthi.np\Downloads\latebinding-using-reflection-Deepthi-NP-25-main\latebinding-using-reflection-Deepthi-NP-25-main\GameApp\bin\Debug\AdvancedLevelLib.dll");
                    ...
                    if (advancedTypeClassRef != null)
                    {
                        if (advancedTypeClassRef.IsClass)
                        {
                            ...
                            if (!_methodRef.IsStatic)
                            {
                                ...
                                object result = _methodRef.Invoke(objRef, new object[] { "jill", 5 });
                                Console.WriteLine(result.ToString());
                            }
